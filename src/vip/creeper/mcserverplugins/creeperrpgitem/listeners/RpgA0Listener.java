 ...
 *  燃烧棒
 */
public class RpgA0Listener implements Listener,IRpgListener {
    ...
    public void execute(Event event) {
        if (event instanceof PlayerInteractByRpgItemEvent) {
            callFireballEvent((PlayerInteractByRpgItemEvent) event);
        }
    ...
    public void callFireballEvent(final PlayerInteractByRpgItemEvent event) {
